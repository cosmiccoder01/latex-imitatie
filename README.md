...
This repository is a fork of the original [`latex-imitatie`](https://github.com/WetenSchaap/latex-imitatie.git), where additional minor features were added, with official-title-page specific for University of Groningen. 
